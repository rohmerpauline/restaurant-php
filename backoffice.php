...
<body>
    ...
    <?php
        ...
        $reponse = $bdd->query('SELECT date_message, prenom_client, nom_client, email_client, objet_message, message_contenu FROM formulaire_contact');
                    ...
                    <table class="table justify-content-center">
                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="backoffice.php?delete=<?php echo $row['id'];?>" class="btn"><i class="fas fa-trash-alt"></i></a>
                                </td>
                        <?php
                            }
                           if(isset($_GET['delete'])){
                               $id = $_GET['delete'];
                               $req->prepare('DELETE FROM formulaire_chat WHERE id = :id');
                               req->execute(array(
                                   'id'=>$id
                               )
                           }
